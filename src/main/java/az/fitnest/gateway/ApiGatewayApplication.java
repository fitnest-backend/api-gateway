    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                .route("catalog-backend", r -> r.path(
                        ...
                        "/api/v1/admin/gyms/{id}/reservation/enable",
                        "/api/v1/admin/gyms/{id}/trainers/{trainerId}/reservation/enable",
                        "/api/v1/admin/gyms/{id}/trainers/{trainerId}/availabilities",
                        "/api/v1/admin/gyms/reservations/{reservationId}/status",
                        "/api/v1/admin/gyms/{id}/lesson-types",
                        "/api/v1/admin/gyms/{id}/lesson-types/{lessonTypeId}",
                        ...
                        "/api/v1/gyms/{gymId}/reservations",
                        "/api/v1/gyms/daily-availability",
                        "/api/v1/gyms/{gymId}/reservation-details",
                        "/api/v1/gyms/reservations",
                        "/api/v1/gyms/reservations/{reservationId}/cancel",
                        "/api/v1/gyms/check-reservation",
